...
const PackageCard = ({ pkg }) => {
  ...
  const canBookNow = /^[a-f0-9]{24}$/i.test(String(pkg._id || ''));
          ...
          <div className="mt-auto flex items-end justify-between gap-4 pt-8">
            <div>
              ...
              <button
                ...
                disabled={!canBookNow}
                className="mt-4 inline-flex items-center rounded-full bg-brand-green px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-brand-green/15 transition hover:bg-green-800 disabled:cursor-not-allowed disabled:opacity-60"
              >
                Book Now
              </button>
            </div>
